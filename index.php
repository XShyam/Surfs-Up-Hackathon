			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Passenger Login </h2>
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm">Email /Phone Number</label>
									<input type="text" placeholder="Email /Phone Number" name="emailreg" class="form-control mb" required="true">
