...
$stmt->execute();
echo"<script>alert('Boat Details has been Updated successfully');</script>";
}
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Boat Details </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Edit Boat Details</div>
	...
	<span class="help-block m-b-none">
													Boat name can't be changed.</span>
						 </div>
						</div>
<div class="form-group">
