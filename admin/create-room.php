...
if($row_cnt>0)
{
echo"<script>alert('Boat alreadt exist');</script>";
}
else
{
...
$stmt->execute();
echo"<script>alert('Boat has been added successfully');</script>";
}
}
?>
<!doctype html>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add a Boat </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Boat</div>
...
<input class="btn btn-primary" type="submit" name="submit" value="Add Boat ">
												</div>
											</div>
