		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Boat Details</h2>
						<div class="panel panel-default">
							<div class="panel-heading">All Boat Details</div>
...
<tr>
<td colspan="6" style="text-align:center; color:blue"><h3>Boat Realted Info</h3></td>
</tr>
