...
$query="insert into  registration(roomno,seater,feespm,stayfrom,duration,firstName,gender,contactno,emailid,egycontactno,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('siisissisisssi',$roomno,$seater,$feespm,$stayfrom,$duration,$fname,$gender,$contactno,$emailid,$emcntno,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
echo"<script>alert('Passenger Succssfully register');</script>";
}
?>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center">Your ride has been booked</h3>
			<div align="center">
			...
			<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">My Ride</div>
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Trip Related info </h4> </label>
</div>
