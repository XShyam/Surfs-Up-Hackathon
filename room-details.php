		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:3%">Ride Details</h2>
						<div class="panel panel-default">
							<div class="panel-heading">Have a Great Ride!!</div>
...
<tr>
<td colspan="6" style="text-align:center; color:blue"><h3>Ride Info</h3></td>
</tr>
<tr>
